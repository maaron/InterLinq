...
namespace InterLinq.UnitTests.Sql
{
    /// <summary>
    ...
    public class CompanyExampleTest
    {
        ...
        public void Avg_01_Grade()
        {
            ...
            Assert.AreEqual(6.0d, Math.Round(avgGrade, 4));
    ...
    public class CompanyExampleTestWcf : CompanyExampleTest
    {
        ...
        {
            companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceWcf(ServiceConstants.SqlServiceName).QueryHandler);
        }
