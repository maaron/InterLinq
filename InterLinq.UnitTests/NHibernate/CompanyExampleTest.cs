...
namespace InterLinq.UnitTests.NHibernate
{
    /// <summary>
    ...
    public class CompanyExampleTest
    {
        ...
        public void Min_02_SalaryInDepartment()
        {
            ...
            foreach (var minSalaryEntry in foundMinSalaries)
            {
                ...
                {
                    Assert.AreEqual(1, minSalaryEntry.LowestSalaryEmployee.Count());
                    Assert.AreEqual(35000d, minSalaryEntry.LowestSalaryEmployee.First().Salary);
                }
                else
                {
    ...
    public class CompanyExampleTestWcf : CompanyExampleTest
    {
        ...
        {
            companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceWcf(ServiceConstants.NhibernateServiceName).QueryHandler);
        }
    ...
    public class CompanyExampleTestRemoting : CompanyExampleTest
    {
        ...
        {
            companyExampleContext = new CompanyContext(ClientEnvironment.GetInstanceRemoting(ServiceConstants.NhibernateServiceName).QueryHandler);
        }
